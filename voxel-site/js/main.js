$(document).ready(function () {
  ...
  (function accordionAccordion() {
    $('.accordion-item-title').on('click', function() {
      ...
      $('.accordion-item.active .accordion-item-answer').animate({height: 'hide'});
  ...
  (function maintenanceSendMail() {
    ...
    $formMail.on('submit', function (event) {
      ...
      $('.yandex-metrika-event').on('click', function() {
        ...
        yaCounter57154331.reachGoal($goal);
        return true;
      });
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          openPopupThanks();
          yaCounter57154331.reachGoal('spasibo');
